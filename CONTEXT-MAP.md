...
- [Portal](./packages/portal/CONTEXT.md): `packages/portal`. The signed-in landing at `/`, the patch card, versions, inline description, sharing and rollback, and confirmation pages for retire, delete, restore with off sources and reassign, over Patches, Companies and Auth. Deactivation/reactivation pick pages remain future work.
