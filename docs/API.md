...
{
  ok: true,
  value: RuntimeMe | { [key: string]: unknown } | null | { [key: string]: unknown } | null[] | { rows: { [key: string]: unknown }[], cursor: string | null } | { [key: string]: unknown }[] | { [key: string]: unknown } | { bytes: string, contentType: string } | { files: { name: string, size: integer, contentType: string, updatedAt: string }[], cursor: string | null } | null
}
```
