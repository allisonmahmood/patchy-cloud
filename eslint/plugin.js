/**
 * The repo's own Oxlint JS rules: the Effect conventions a linter can hold.
...
export default {
  meta: { name: "patchy" },
  rules: {
    // Oxlint accepts but ignores regex restrictions; keep ESLint's import-boundary rule.
