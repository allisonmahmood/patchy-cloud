...
- `packages/primitives` — additive table/store provisioning, schema revisions, bounded row operations and immutable file operations over Postgres and PGlite (`@patchy/primitives`).
